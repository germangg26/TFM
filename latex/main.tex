...
\pagestyle{fancy}
\fancyhf{}
% Izquierda: nombre del máster | Derecha: capítulo
\fancyhead[L]{\footnotesize\textsc{MSc. Modelling for Science and Engineering}}
...
\newtcolorbox{hallazgo}{
  ...
  fonttitle=\bfseries\small, title={Hallazgo clave}
}
...
% ── Metadatos ────────────────────────────────────────────────────────────────
\title{Aprendizaje automático para email marketing: propensión, recomendación y previsión con validación rigurosa}
\author{Germán}
\date{2026}
...
\input{chapters/04_sistema_evaluacion}

\part{Modelos}
\input{chapters/05_segmentacion}
\input{chapters/06_propension}
\input{chapters/07_recomendador}
\input{chapters/08_forecast}

\part{Aplicación y cierre}
\input{chapters/09_negocio}
\input{chapters/10_conclusiones}

\appendix
\input{chapters/11_apendice_reproducibilidad}
